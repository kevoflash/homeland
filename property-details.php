...
<?php 
  ...
  if(isset($_GET['id'])) {
    ...
    $relatedProps = $conn->query("SELECT * FROM props WHERE office_type = '$allDetails->office_type' 
    AND id != '$id'");
            ...
            <div class="bg-white property-body border-bottom border-left border-right">
              ...
              <div class="row mb-5">
                <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                  <span class="d-inline-block text-black mb-0 caption-text">Office Type</span>
                  <strong class="d-block"><?php echo str_replace('-', ' ', $allDetails->office_type); ?></strong>
                </div>
                <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                ...
                <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                  ...
                  <strong class="d-block">Ksh<?php echo $allDetails->price_sqft; ?></strong>
                </div>
              </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="property-entry h-100">
              ...
              <div class="p-4 property-body">
                ...
                <strong class="property-price text-primary mb-3 d-block text-success">ksh<?php echo $allRelatedProp->price; ?></strong>
